...
public class ZEDSpatialMapping
{
    ...
    public bool LoadMesh(string meshFilePath = "ZEDMesh.obj")
    {
        ...
        if (zedCamera.EnableTracking(ref quat, ref tr, true, false, false, false, true, -1.0f, sl.SENSOR_WORLD.IMU_GRAVITY, System.IO.File.Exists(basePath + ".area") ? basePath + ".area" : "") != sl.ERROR_CODE.SUCCESS)
        {
