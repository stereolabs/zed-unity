...
///
/// Basic wireframe shader with alpha color that can be used for rendering planes.
/// This will draw a mesh along with 0.5 transparency inside the vertices
///
Shader "Custom/Plane Detection/ GeometryWirePlane"
{
	Properties
	{
...
#include "UnityCG.cginc"
	...
	void frag(g2f i, out half4 outColor : SV_Target)
	{
		...
		// quickly to go back to half transparency
		float I = exp2(-2 * dist * dist / 10)+ 0.2;
